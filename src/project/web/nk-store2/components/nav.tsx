...
export default function Nav(){
    ...
    <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-6 py-3">
        ...
        <div className="order-1 md:order-2">
            <Link className="flex items-center tracking-wide no-underline hover:no-underline font-bold text-gray-800 text-xl " aria-label="Home" href="/">
        ...
        <div className="order-2 md:order-3 flex items-center" id="nav-content">
            ...
            <Link className="inline-block no-underline hover:text-black" aria-label="Profile" href="/profile">
            ...
            <Link className="pl-3 inline-block no-underline hover:text-black" aria-label="Cart" href="/cart">
                <svg className="fill-current hover:text-black" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
